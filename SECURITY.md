...
- MAYA Sentinel is static analysis tooling, not a production service.
...
- MAYA Sentinel runs locally by default; do not expose its loopback development server directly to the internet.
